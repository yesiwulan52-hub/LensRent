...
// Dashboard Breeze (bisa diakses setelah login)
Route::get('/dashboard', function () {
    return view('dashboard');
})->middleware(['auth', 'verified'])->name('dashboard');

// Rute untuk melihat daftar kamera (hanya user login, baik admin maupun customer)
